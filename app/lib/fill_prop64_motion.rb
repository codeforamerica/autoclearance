class FillProp64Motion
  ...
  def filled_motion
    ...
    code_sections = counts.map(&:code_section)
    ...
    pdftk.fill_form 'app/assets/motions/prop64.pdf', tempfile.path, {
        ...
        "11357  Possession of Marijuana" => on_or_off(code_sections.include? "HS 11357"),
        "11358  Cultivation of Marijuana" => on_or_off(code_sections.include? "HS 11358"),
        "11359  Possession of Marijuana for Sale" => on_or_off(code_sections.include? "HS 11359"),
        "11360  Transportation Distribution or" => on_or_off(code_sections.include? "HS 11360"),
    }
